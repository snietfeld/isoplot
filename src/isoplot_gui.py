...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.plot_treeView = QtGui.QTreeView(self.groupBox_2)
        self.plot_treeView.setObjectName(_fromUtf8("plot_treeView"))
        self.verticalLayout_4.addWidget(self.plot_treeView)
        ...
        self.data_treeView = QtGui.QTreeView(self.groupBox)
        self.data_treeView.setObjectName(_fromUtf8("data_treeView"))
        self.verticalLayout_3.addWidget(self.data_treeView)
        ...
        self.actionAdd_plotting_library = QtGui.QAction(MainWindow)
        self.actionAdd_plotting_library.setObjectName(_fromUtf8("actionAdd_plotting_library"))
        self.menuSettings.addAction(self.actionSet_default_directory)
        self.menuSettings.addAction(self.actionAdd_plotting_library)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionAdd_plotting_library.setText(_translate("MainWindow", "Add plotting library", None))
